...
class SalesReportPolicy
{
    ...
    {
        return $user->can('view_any_sales::report');
    }
    ...
    {
        return $user->can('view_sales::report');
    }
    ...
    {
        return $user->can('create_sales::report');
    }
    ...
    {
        return $user->can('update_sales::report');
    }
    ...
    {
        return $user->can('delete_sales::report');
    }
    ...
    {
        return $user->can('delete_any_sales::report');
    }
     ...
     */
    public function replicate(User $user, SalesReport $salesReport): bool
    {
